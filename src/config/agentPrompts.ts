...
{ "action":"respond|navigate|highlight|open_modal|search|none", "target":"<path_or_selector_or_query>", "confidence":0.0-1.0, "summary":"short reply for UI", "speak": true|false, "meta":{} }
Rules:
...
User: "${user}"
Please output only the JSON described in system prompt. If user asks to navigate, include route path. If user speaks ambiguous navigation, prefer asking a confirmation (action: "respond", confidence < 0.6).
